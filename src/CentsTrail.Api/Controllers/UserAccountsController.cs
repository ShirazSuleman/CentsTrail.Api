...
using CentsTrail.Api.Models.UserAccounts.ChangePassword;
using CentsTrail.Api.Models.UserAccounts.Register;
...
namespace CentsTrail.Api.Controllers
{
  ...
  public class UserAccountsController : ApiController
  {
    ...
    public UserAccountsController(ApplicationUserManager userManager)
    {
    ...
    // POST UserAccounts/ChangePassword
